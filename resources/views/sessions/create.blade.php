          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('sessions.store') }}">
              	{{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputSessionName">Session Title<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="title" class="form-control" id="labelInputSessionName" placeholder="Enter session title" value="{{ Request::old('title') }}">
                  </div>
                  <div class="form-group">
                      <label for="labelInputYear">Year<i class="fa fa-star-of-life required-label"></i></label>
                      <input type="number" id="year" name="year" class="form-control" id="labelInputYear" placeholder="Enter year e.g (2021) " value="{{ Request::old('year') }}">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input id="datemask" type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask="" inputmode="numeric" name="result_declaration_date" value="{{ Request::old('result_declaration_date') }}">
                      </div>
                    </div>
                    <div class="form-group">
