          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">{{ $card_title }} of &nbsp;<a href="javascript:void(0);">{{ $student->name }}</a> s/d of <a href="javascript:void(0);">{{ $student->father_name }}</a> r/o <a href="javascript:void(0);">{{ $student->home_address }}</a> for <a href="javascript:void(0);">{{ $semester->title }}</a></small></h3>
              </div>
              <!-- /.card-header -->
                @if($errors->any())
	              <div class="">
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('students.storefee') }}">
              	{{ csrf_field() }}
