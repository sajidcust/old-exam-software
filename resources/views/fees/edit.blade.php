          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('fees.update') }}">
              	{{ csrf_field() }}
                <input id="hidden_identifier" type="hidden" value="{{ $fee->id }}" name="fee_id">
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputFeeTitle">Fee Title<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="title" class="form-control" id="labelInputFeeTitle" placeholder="Enter fee title" value="{{ $fee->title }}" value="{{ Request::old('title') != '' ? Request::old('title'):$fee->title }}">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" data-inputmask="'mask': '9999'" data-mask="" inputmode="text" name="amount" value="{{ Request::old('amount')!='' ? Request::old('amount'): $fee->amount }}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
