...
<head>
<meta charset="UTF-8">
<title>Gazette Secretary Message Page {{ $session->title }} - {{ $standard->name }}</title>
...
@if($setting->secretary_image != '')
<?php $secretary_image = ltrim($setting->secretary_image, $setting->secretary_image[0]); ?>
  <table style="height: 107px; width: 100%; border-collapse: collapse; border-style: none;" border="1">
  <tbody>
  <tr style="height: 39px;">
  <td style="width: 100%; height: 39px; border-style: none; text-align: center;"><img src="{{ $secretary_image }}" alt="" width="150"></td>
  </tr>
  </tbody>
  </table>
@endif
