...
<table width="100%">
  <tr>
      <td style="padding-top:20px;" valign="top" align="center">
        ...
        <h1 style="padding:0px;margin:0px;text-align:center;font-size:15px;font-weight:600;text-decoration:underline;">OVERALL TOP 10 POSITIONS OF CLASS {{ $standard->name }}</h1>
      </td>
  </tr>
...
<table class="GeneratedTable">
  ...
  <tbody>
    <?php $i=1; ?>
    <?php $gazettes = App\Models\StudentsExam::getOverAllToppersList($session->id, $standard->id); ?>
    @if(count($gazettes)>0)
