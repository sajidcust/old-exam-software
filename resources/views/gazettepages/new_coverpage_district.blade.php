...
<head>
<meta charset="UTF-8">
<title>District Gazette Cover Page {{ $session->title }} - {{ $standard->name }} - {{ $district->name }}</title>
...
<tr>
<td style="width: 100%; border-style: none; text-align: center;">
<h1 style="text-decoration: underline;">DISTRICT {{ strtoupper($district->name) }}</h1>
</td>
</tr>
</tbody>
</table>
