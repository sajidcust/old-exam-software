          ...
          <div class="col-12">
	        ...
	        <div class="row">
	          <div class="col-md-12">
	            ...
	            @endif
	            <form id="quickForm" method="post" action="{{ route('exams.update') }}" class="form-horizontal" enctype="multipart/form-data">
                	{{ csrf_field() }}
	              ...
	              <!-- /.card-body -->
	                <div class="card-footer">
	                  <div class="display-inline">
	                    <button type="submit" disabled id="save_button" class="btn btn-primary pull-right-button">Save</button>
	                  </div>
	                </div>
				</form>
	            </div>
