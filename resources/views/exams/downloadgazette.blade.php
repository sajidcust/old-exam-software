...
<body>
  ...
  @foreach($standards as $standard)
    ...
    <table width="100%">
      <tr>
          <td style="padding-top:20px;" valign="top" align="center">
            ...
            <h1 style="padding:0px;margin:0px;text-align:center;font-size:15px;font-weight:600;text-decoration:underline;">EXAMINATION GAZETTE OF {{ strtoupper($center->name) }} FOR {{ strtoupper($session->title). ' '.strtoupper($semester->title) }} (CLASS {{ strtoupper($standard->name) }})</h1>
          </td>
      </tr>
    ...
    <table class="GeneratedTable">
      <thead>
        <?php $subjects = App\Models\StudentsExam::getSubjects($session->id, $semester->id, $center_id, $standard->id); ?>
        <tr>
      ...
      <tbody>
        <?php $i=1; ?>
        <?php $students = App\Models\StudentsExam::getStudents($session->id, $semester->id, $standard->id, $center_id); ?>
        @foreach($students as $student)
          <tr>
            ...
            <?php $t_subjects = App\Models\StudentsExam::getSubjectsAndMarksDetails($session->id, $semester->id, $center_id, $standard->id, $student->roll_no); ?>
