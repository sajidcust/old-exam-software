...
<head>
<meta charset="UTF-8">
<title>Roll No Slip Of {{ $student->name }}</title>
  ...
  <table width="100%">
    <tr>
        ...
        <td style="padding-top:20px;" valign="top" align="center">
          ...
          <h1 style="padding:0px;margin:0px;text-align:center;font-size:12px;font-weight:600;text-decoration:underline;">DATESHEET FOR EXAMINATIONS {{ strtoupper($student->session_title) }}</h1>
        </td>
  ...
  <table width="100%">
    <tbody width="100%">
      <tr width="100%">
        ...
        <td width="100"></td>
        <td width="100"></td>
        <td width="20" style="padding-left:20px" rowspan="3"><img style="border:2px solid #ccc;" src="img/default_img.jpg" alt="" width="75"/></td>
      </tr>
      <tr width="100%">
