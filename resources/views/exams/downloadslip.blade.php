  ...
  <table width="100%">
    <tr>
        ...
        <td style="padding-top:20px;" valign="top" align="center">
          ...
          <h1 style="padding:0px;margin:0px;text-align:center;font-size:11px;font-weight:600;text-decoration:underline;">DATESHEET FOR EXAMINATIONS {{ strtoupper($student->session_title) }}</h1>
        </td>
