...
if($percentage_marks >= 80) {
  ...
  <td style="font-size: 11px; width: 19.1438%; border-style: none;">
    &nbsp;
  </td>
  </tr>
  <tr>
  <td style="font-size: 11px; width: 5.43276%; border-style: none;">&nbsp;</td>
  <td style="font-size: 11px; width: 75.4234%; border-style: none;">Result Declaration Date:&nbsp; <strong>{{ 
  date('d F, Y', strtotime($session->result_declaration_date)) }}</strong></td>
  <td style="font-size: 11px; width: 19.1438%; font-weight: bold; border-style: none; text-align: center;">
    {{ $student->class_id == 1001 ? 'Deputy ': '' }}Controller Of Examinations
  </td>
  </tr>
  </tbody>
  </table>
