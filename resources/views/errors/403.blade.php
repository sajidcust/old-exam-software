      ...
      <div class="card-body login-card-body">
        <div class="error-page">
          ...
          <div class="error-content">
            <h3><i class="fas fa-exclamation-triangle text-danger"></i> Oops! Forbidden Access</h3>

            <p>
              The webpage or other resource you're trying to open in your web browser is a resource that you're not allowed to access. Please try again later.
