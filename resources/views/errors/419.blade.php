...
<div class="login-box width-auto">
  <div class="login-logo">
    <a href="{{ url('/') }}">
      ...
      <h4 class="theme_color family-century">Directorate of Colleges (DOEC-GB)</h4>
    </a>
  </div>
  <!-- /.login-logo -->
  <div class="content">
      ...
      <div class="card-body login-card-body">
        <div class="error-page">
          ...
          <div class="error-content">
            ...
            <p>
              You're seeing this because the page or session might be expired or the a CSRF (cross site request forgery) token is a unique, encrypted value generated by the server. Please try again later.
