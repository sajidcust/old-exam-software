      ...
      <div class="card-body login-card-body">
        <div class="error-page">
          ...
          <div class="error-content">
            ...
            <p>
              Your app has made too many requests and has hit the rate limit of an API.This is a client error sent back from the server to signal that you've reached your maximum allowed limit. Please try again later.
