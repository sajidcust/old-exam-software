      ...
      <div class="card-body login-card-body">
        <div class="error-page">
          ...
          <div class="error-content">
            ...
            <p>
              Sorry for the inconvinience. The server encountered an unexpected condition that prevented it from fulfilling your request. We are working on it and soon be able to resolve the issue. Thanks for your patience and please try again later.
