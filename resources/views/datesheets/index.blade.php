          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header row">
              	...
              	<div class="col-lg-6">
              		<a href="{{ url('admin/datesheets/create') }}" class="btn btn-info custom-pull-right"><span class="fa fa-plus-square"></span>&nbsp;&nbsp;New</a>
              	</div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
	  ...
	  $(document).ready(function() {
        $('#manageDatatable').DataTable({
            ...
            columns:[
              ...
              {
                data: 'paper_starting_time',
                name: 'paper_starting_time'
              },
              {
                data: 'paper_ending_time',
                name: 'paper_ending_time'
              },
              {
                data: 'class',
                name: 'class'
