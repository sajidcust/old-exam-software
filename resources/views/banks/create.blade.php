              ...
              <form id="quickForm" method="post" action="{{ route('banks.store') }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputBankName">Bank Name<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="name" class="form-control" id="labelInputBankName" placeholder="Enter bank name" value="{{ Request::old('name') }}">
                  </div>
                </div>
                <!-- /.card-body -->
