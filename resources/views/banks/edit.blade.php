          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('banks.update') }}">
              	{{ csrf_field() }}
                <input id="hidden_identifier" type="hidden" value="{{ $bank->id }}" name="bank_id">
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputCLassName">CLass Name<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="name" class="form-control" id="labelInputCLassName" placeholder="Enter bank name" value="{{ $bank->name }}" value="{{ Request::old('name') != '' ? Request::old('name'):$bank->name }}">
                  </div>
                </div>
                <!-- /.card-body -->
