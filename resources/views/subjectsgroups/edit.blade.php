          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('subjectgroups.update') }}" enctype="multipart/form-data">
              	{{ csrf_field() }}
                <input id="hidden_identifier" type="hidden" value="{{ $subjectgroup->id }}" name="subject_group_id">
                ...
                <div class="card-body">
                    ...
                    <select class="custom-select rounded-0 select2" id="labelInputSelectClass" name="class_id">
                      ...
                      @foreach($standards as $standard)
                          @if(Request::old('class_id') == '')
                              @if($standard->id == $subjectgroup->class_id)
                   ...
                   <div class="form-group">
                    <label for="labelInputSelectSubject">Select Subject<i class="fa fa-star-of-life required-label"></i></label>
                    <select class="custom-select rounded-0 select2" id="labelInputSelectSubject" name="subject_id">
                      ...
                      @foreach($subjects as $subject)
                          @if(Request::old('subject_id') == '')
                              @if($subject->id == $subjectgroup->subject_id)
