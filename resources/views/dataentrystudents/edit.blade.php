          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h3 class="card-title float-lg-right"><b>Step 1 of 2</b></h3>
              </div>
              <!-- /.card-header -->
                @if($errors->any())
	              <div class="">
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('destudents.update') }}" enctype="multipart/form-data">
              	{{ csrf_field() }}
                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      <label for="labelInputStudentName">Student Name<i class="fa fa-star-of-life required-label"></i></label>
                   ...
                   <div class="form-group">
                      <label for="labelInputFatherName">Father Name<i class="fa fa-star-of-life required-label"></i></label>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="labelInputDOBInWords">DOB (In Words)<i class="fa fa-star-of-life required-label"></i></label>
                   ...
                   <div class="form-group">
                      <label for="labelInputHomeAddress">Home Address<i class="fa fa-star-of-life required-label"></i></label>
...
<script>
  $('select[name="class_id"]').change(function(){
    ...
    var url = "{{ route('destudents.getsubjectsgroupdata') }}";
  ...
  /*$(document.body).on("change","select[name='fee_id']" ,function(){
    ...
    $('#quickForm select[name="fee_id"]').select2({
      ajax: {
        url: "{{ route('destudents.getFeeData') }}",
        dataType: 'json',
