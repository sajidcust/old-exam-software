...
<div class="wrapper">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                ...
                @elseif(auth()->user()->user_role == 2)
                    <a href="{{ url('assessmentcenter/dashboard') }}" class="nav-link"><span
                                class="fa fa-tachometer-alt"></span>&nbsp;&nbsp;Home</a>
                @else
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" class="brand-link">
            <img src="{{ url('/img/gbdoelogo_white.png') }}" alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ auth()->user()->image == '' ? url('/img/default-prof-img.jpg') : url(auth()->user()->image) }}"
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-flat"
                    ...
                    <li class="nav-item">
                        ...
                        {{--                        @elseif(auth()->user()->user_role == 2)--}}
                        {{--                            <a href="{{ url('assessmentcenter/dashboard') }}" class="nav-link"></a>--}}
                        {{--                        @else--}}
                        {{--                            <a href="{{ url('dataentry/index') }}" class="nav-link"></a>--}}
                        {{--                        @endif--}}
                    ...
                    @can('menu approvals')
                        ...
                        <li class="nav-item {{ $selected_main_menu == 'user_approvals' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#" class="nav-link {{ $selected_main_menu == 'user_approvals' ? 'active':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('user-management.registration-requests')}}"
                                       class="nav-link {{ $selected_sub_menu == 'registration_requests' ? 'active open':'' }}">
                    ...
                    @can('menu user management')
                        <li class="nav-item {{ $selected_main_menu == 'user' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#" class="nav-link {{ $selected_main_menu == 'user' ? 'active':'' }}">
                                <i class="nav-icon fas fa-building"></i>
                                <p>
                                    User Management
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('user-management.index')}}"
                                       class="nav-link {{ $selected_sub_menu == 'user_index' ? 'active open':'' }}">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('user-management.create')}}"
                                       class="nav-link {{ $selected_sub_menu == 'user_create' ? 'active open':'' }}">
                    ...
                    @can('menu user roles')
                        <li class="nav-item {{ $selected_main_menu == 'roles' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#" class="nav-link {{ $selected_main_menu == 'roles' ? 'active':'' }}">
                                <i class="nav-icon fas fa-building"></i>
                                <p>
                                    User Roles
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('roles.index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'roles_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('roles.create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'roles_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu user permissions')
                        <li class="nav-item {{ $selected_main_menu == 'permissions' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#" class="nav-link {{ $selected_main_menu == 'permissions' ? 'active':'' }}">
                                <i class="nav-icon fas fa-building"></i>
                                <p>
                                    User Permissions
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('permissions.index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'permissions_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('permissions.create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'permissions_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu districts')
                        ...
                        <li class="nav-item {{ $selected_main_menu == 'districts' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/districts/index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/districts/create') }}"
                    ...
                    @can('menu tehsils')
                        <li class="nav-item {{ $selected_main_menu == 'tehsils' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/tehsils/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'tehsils_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/tehsils/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'tehsils_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu sessions')
                        <li class="nav-item {{ $selected_main_menu == 'sessions' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/sessions/index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/sessions/create') }}"
                    ...
                    @can('menu semesters')
                        <li class="nav-item {{ $selected_main_menu == 'semesters' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/semesters/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'semesters_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/semesters/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'semesters_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu banks')
                        <li class="nav-item {{ $selected_main_menu == 'banks' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/banks/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'banks_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/banks/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'banks_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu fees')
                        <li class="nav-item {{ $selected_main_menu == 'fees' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/fees/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'fees_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/fees/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'fees_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/fees/generatefeedetails') }}"
                                       class="nav-link {{ $selected_sub_menu == 'fees_details' ? 'active open':'' }}">
                  ...
                  <li class="nav-item">
                    ...
                    @can('menu classes')
                        <li class="nav-item {{ $selected_main_menu == 'classes' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/classes/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'classes_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/classes/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'classes_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu subjects')
                        <li class="nav-item {{ $selected_main_menu == 'subjects' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/subjects/index') }}"
                    ...
                    @can('menu subject groups')
                        <li class="nav-item {{ $selected_main_menu == 'subject_groups' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#"
                               class="nav-link {{ $selected_main_menu == 'subject_groups' ? 'active':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/subjectgroups/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'subject_groups_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/subjectgroups/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'subject_groups_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                    ...
                    @can('menu datasheets')
                        <li class="nav-item {{ $selected_main_menu == 'datesheets' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/datesheets/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'datesheets_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/datesheets/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'datesheets_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/datesheets/printdatesheets') }}"
                                       class="nav-link {{ $selected_sub_menu == 'print_datesheets' ? 'active open':'' }}">
                    ...
                    @can('menu institutions')
                        <li class="nav-item {{ $selected_main_menu == 'institutions' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/institutions/index') }}"
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/institutions/create') }}"
                    ...
                    @can('menu students')
                        <li class="nav-item {{ $selected_main_menu == 'students' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/students/index') }}"
                                       class="nav-link {{ $selected_sub_menu == 'students_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>View All</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/students/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'students_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/students/search') }}"
                                       class="nav-link {{ $selected_sub_menu == 'search_students' ? 'active open':'' }}">
                    ...
                    @can('menu exams')
                        <li class="nav-item {{ $selected_main_menu == 'exams' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/editmarksbysearch') }}"
                                       class="nav-link {{ $selected_sub_menu == 'exams_index' ? 'active open':'' }}">
                                        <i class="far fa-edit nav-icon"></i>
                                        <p>Edit Marks</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/updatemarksbycenters') }}"
                                       class="nav-link {{ $selected_sub_menu == 'update_marks_by_centers' ? 'active open':'' }}">
                                        <i class="far fa-edit nav-icon"></i>
                                        <p>Edit Marks By Centers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/generateslips') }}"
                                       class="nav-link {{ $selected_sub_menu == 'exams_slips' ? 'active open':'' }}">
                                        <i class="far fa-file-alt nav-icon"></i>
                                        <p>Generate Slips</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/generateawardsheetbydata') }}"
                                       class="nav-link {{ $selected_sub_menu == 'exams_awardsheets' ? 'active open':'' }}">
                                        <i class="far fa-calendar-alt nav-icon"></i>
                                        <p>Generate Awardsheets</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/generategazette') }}"
                                       class="nav-link {{ $selected_sub_menu == 'exams_gazettes' ? 'active open':'' }}">
                                        <i class="far fa-clipboard nav-icon"></i>
                                        <p>Generate Gazettes</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/exams/generatemarksheetsbysearch') }}"
                                       class="nav-link {{ $selected_sub_menu == 'exams_marksheets' ? 'active open':'' }}">
                    ...
                    @can('menu import or export')
                        <li class="nav-item {{ $selected_main_menu == 'importsexports' ? ' menu-is-opening menu-open':'' }}">
                            <a href="#"
                               class="nav-link {{ $selected_main_menu == 'importsexports' ? 'active':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/importsexports/import') }}"
                                       class="nav-link {{ $selected_sub_menu == 'import' ? 'active open':'' }}">
                                        <i class="far fa-folder nav-icon"></i>
                                        <p>Import</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/importsexports/export') }}"
                                       class="nav-link {{ $selected_sub_menu == 'export' ? 'active open':'' }}">
                    ...
                    @can('menu students')
                        ...
                        <li class="nav-item {{ $selected_main_menu == 'students' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('dataentry/students/searchbycenter') }}"
                                       class="nav-link {{ $selected_sub_menu == 'students_index' ? 'active open':'' }}">
                                        <i class="far fa-eye nav-icon"></i>
                                        <p>Search</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('dataentry/students/create') }}"
                                       class="nav-link {{ $selected_sub_menu == 'students_create' ? 'active open':'' }}">
                                        <i class="far fa-plus-square nav-icon"></i>
                                        <p>Create</p>
                                    </a>
                    ...
                    @can('menu exams')
                        ...
                        <li class="nav-item {{ $selected_main_menu == 'marks_update' ? ' menu-is-opening menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('assessmentcenter/marks/editmarksbysearch') }}"
                                       class="nav-link {{ $selected_sub_menu == 'marks_index' ? 'active open':'' }}">
                                        <i class="far fa-edit nav-icon"></i>
                                        <p>Update Marks</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('assessmentcenter/marks/updatemarksbycenters') }}"
                                       class="nav-link {{ $selected_sub_menu == 'update_marks_by_centers' ? 'active open':'' }}">
                                        <i class="far fa-edit nav-icon"></i>
                                        <p>Edit Marks By Centers</p>
                                    </a>
                    ...
                    @can('menu settings')
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/settings/index') }}"
                               class="nav-link {{ $selected_sub_menu == 'settings_index' ? 'active open':'' }}">
                    ...
                    @can('menu failed jobs')
                        <li class="nav-item">
                            <a href="{{ url('admin/failedjobs/index') }}"
                               class="nav-link {{ $selected_sub_menu == 'failed_jobs_index' ? 'active open':'' }}">
    ...
    <footer class="main-footer">
        ...
        <strong>Powered by <a href="#">Highlander Connection &copy;</a>.</strong> Heli Chowk, Near FCNA HQ, Jutial
        Gilgit
    </footer>
