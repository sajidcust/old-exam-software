          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header row">
              	...
              	<div class="col-lg-6">
              		<a href="{{ url('admin/semesters/create') }}" class="btn btn-info custom-pull-right"><span class="fa fa-plus-square"></span>&nbsp;&nbsp;New</a>
              	</div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
	  ...
	  $(document).ready(function() {
        $('#manageDatatable').DataTable({
            ...
            columns:[
              ...
              {
                data: 'division_percentage',
                name: 'division_percentage'
              },
              {
                data: 'created_at',
                name: 'created_at'
