          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('semesters.store') }}">
              	{{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputSemesterTitle">Semester Title<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="title" class="form-control" id="labelInputSemesterTitle" placeholder="Enter semester title" value="{{ Request::old('title') }}">
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" data-inputmask="'mask': '9999'" data-mask="" inputmode="text" name="division_percentage" value="{{ Request::old('division_percentage') }}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
