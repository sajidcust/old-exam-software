          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('classes.store') }}">
              	{{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputClassName">Class Name<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="name" class="form-control" id="labelInputClassName" placeholder="Enter class name" value="{{ Request::old('name') }}">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" data-inputmask="'mask': '9999'" data-mask="" inputmode="text" name="min_subjects" value="{{ Request::old('min_subjects') }}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" data-inputmask="'mask': '9999'" data-mask="" inputmode="text" name="min_age" value="{{ Request::old('min_age') }}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
