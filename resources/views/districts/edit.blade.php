          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
	            ...
	            @endif
              <!-- form start -->
              <form id="quickForm" method="post" action="{{ route('districts.update') }}">
              	{{ csrf_field() }}
                <input id="hidden_identifier" type="hidden" value="{{ $district->id }}" name="district_id">
                <div class="card-body">
                  <div class="form-group">
                    <label for="labelInputDistrictName">District Name<i class="fa fa-star-of-life required-label"></i></label>
                    <input type="text" name="name" class="form-control" id="labelInputDistrictName" placeholder="Enter district name" value="{{ $district->name }}" value="{{ Request::old('name') != '' ? Request::old('name'):$district->name }}">
                  </div>
                </div>
                <!-- /.card-body -->
