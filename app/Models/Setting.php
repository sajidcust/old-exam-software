...
class Setting extends Model
{
    ...
    protected $fillable = array('board_full_name', 'minister_name', 'minister_image', 'ministers_message', 'secretary_name', 'secretary_image', 'secretarys_image', 'controller_name', 'controller_image', 'controllers_message', 'deputy_controller_name', 'deputy_controller_signature');
