...
class User extends Authenticatable
{
	...
	public static $rules_personalinfo = [
		'name'           => 'required|min:3',
	...
	public static $rules_personalinfo_edit = [
		'name'           => 'required|min:3',
		'father_name'    => 'required|min:3',
		'postal_address' => 'required|min:10',
		'date_of_birth'  => 'required|date|date_format:d-m-Y|isgtminage|isltmaxage',
	...
	public static $rules_createuser = [
		'name'             => 'required|min:3',
	...
	public static $rules_createuserinnomination = [
		'name'             => 'required|min:3',
		'email'            => 'required|min:8|unique:users',
		'password'         => [
			'required',
	...
	public function course_priorities( $student_id, $nomination_id )
	{
		$excourses = DB::select(
            ...
            "), [ 'nomination_id' => $nomination_id, 'student_id' => $student_id ]
		);
