...
class DataEntryStudentsController extends Controller
{
    ...
    public function updatefee($id, $semester_id)
    {
        ...
        return view('dataentrystudents.updatefee')
            ->with('fees', $fees)
            ->with('banks', $banks)
    ...
    public function updatefeestep($id, $semester_id)
    {
        $this->selected_sub_menu = "students_create";
        $this->card_title = "Please fill in the form below to update fee details";
    ...
    public function edit($id)
    {
        ...
        $subjects = Subject::all();
        $standards = Standard::all();
        return view('dataentrystudents.edit')
            ->with('student', $student)
            ->with('institutions', $institutions)
            ->with('sessions', $sessions)
            ->with('subjects', $subjects)
