...
Route::get('user-management/register', [ UserManagementController::class, 'register' ])->name('user-management.register');
Route::post('user-management/submit/registration/form', [ UserManagementController::class, 'submitRegistration' ])->name('user-management.submit.registration');
...
Route::group([ 'prefix' => 'admin', 'middleware' => 'auth' ], function () {
	...
	Route::get('user-management/index', [ UserManagementController::class, 'index' ])->name('user-management.index');
	Route::get('user-management/registration/requests', [ UserManagementController::class, 'registrationRequests' ])->name('user-management.registration-requests');
	...
	Route::get('user-management/delete/{id}', [ UserManagementController::class, 'destroy' ])->name('user-management.delete');


	Route::get('backend/roles/index', [ RolesController::class, 'index' ])->name('roles.index');
	Route::get('backend/roles/create', [ RolesController::class, 'create' ])->name('roles.create');
	Route::post('backend/roles/store', [ RolesController::class, 'store' ])->name('roles.store');
	Route::get('backend/roles/edit/{id}', [ RolesController::class, 'edit' ])->name('roles.edit');
	Route::post('backend/roles/update/{id}', [ RolesController::class, 'update' ])->name('roles.update');


	Route::get('backend/permissions/index', [ PermissionsController::class, 'index' ])->name('permissions.index');
	Route::get('backend/permissions/create', [ PermissionsController::class, 'create' ])->name('permissions.create');
	Route::post('backend/permissions/store', [ PermissionsController::class, 'store' ])->name('permissions.store');
	Route::get('backend/permissions/edit/{id}', [ PermissionsController::class, 'edit' ])->name('permissions.edit');
	Route::post('backend/permissions/update/{id}', [ PermissionsController::class, 'update' ])->name('permissions.update');
